...
const Header = () => {
  return (
    <div className="flex flex-row items-center justify-center mt-5 ">
      ...
      <header className="rtl hidden h-20 w-screen flex-row-reverse items-center gap-12 bg-rose-500  font-bodyFont text-lg text-white md:flex">

        <Image src={logo} width={50} alt="" className="rounded-full bg-white mr-20" />
        <div className="w-screen flex gap-12  flex-row justify-center items-center absolute">
