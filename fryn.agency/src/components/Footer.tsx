    ...
    return (
        <>
            ...
            <div className="bg-rose-500 h-auto  font-bodyFont text-white pt-40">
                <div className="title flex flex-col lg:px-20 px-10 lg:items-end items-center">
                ...
                <div className="flex lg:flex-row flex-col justify-end lg:items-end items-center lg:p-0 px-7"> 
                <Image src={speaker} alt='' className=' lg:block hidden lg:w-[60vw] w-[40vw] -translate-x-40'/>
